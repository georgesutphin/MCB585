...
1. [R software](https://cran.r-project.org/)
...
&nbsp;
#### Generative AI is your friend

While you don't want to use AI to write the code for you (the goal here is to learn how to do that yourself and current-generation generative AI is still not great at specialized analysis), it is quite good at general coding. It can be a great resource to help troubleshoot your code and answer your questions. Use it as a learning aid or a tutor to get fast answers on why your code isn't working or to figure out the right function to use for a specific task.
