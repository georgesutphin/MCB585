---
title: "Lesson 1: Getting started with R and RStudio -- Additional Detail"
classdate: "Lesson 1 -- On Your Own"
teaching: 90
exercises: 30
questions:
...
The book *R Packages* includes a [chapter](http://r-pkgs.org/) on this and other style considerations.
...
source("my_genius_fxns.R") # not intended to be run
```
...
* [Statistics Consulting Lab (StatLab)](https://cb2.arizona.edu/services/statistics-consulting-lab) (pay service, free consultation)
* [Cancer Center Biostatistics & Bioinformatics](https://cancercenter.arizona.edu/researchers/ccsg-supported-shared-resources/biostatistics-bioinformatics)
