---
title: "Lesson 2: Basic Data Types and Data Structures in R"
classdate: "Lesson 2 -- In Class"
teaching: 90
exercises: 30
questions:
...
The major exception is the backslash (`\`), which R uses as an escape character. In computing, an escape character is a *meta-character* that is not interpreted literally, but instead causes the computer to interpret *the character following the escape character* in a different way.
...
dog.person
cat.person # note that cat.person is unchanged
```
