---
title: "Lesson 3: Data Frames, Basic Indexing, Reading/Writing Data"
classdate: "Lesson 3 -- In Class"
teaching: 90
exercises: 30
questions:
...
>
> Use the `>` operator to create a new data frame that is the subset of `iris` with sepal length greater than 5.0.
> 
> > ## Solution
> > ```{r}
...
```{r, fig.cap="", fig.align="left", out.width = "350px", echo = FALSE}
