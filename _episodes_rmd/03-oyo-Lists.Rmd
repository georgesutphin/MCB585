---
title: "Lesson 3: Lists and Advanced Indexing"
classdate: "Lesson 3 -- On Your Own"
teaching: 90
exercises: 30
questions:
...
Because this data is formatted as a list, we can extract specific components for further use (e.g. to print onto a chart, or use to separate significant comparisons from a computed set of t-tests) using either `[[]]` or `$`. Let's pull the p-value for instance:
