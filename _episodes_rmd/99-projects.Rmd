...
The project is composed of three parts: (1) a proposal, (2) a final written report with code, and (3) an oral presentation. See the course syllabus for how these components contribute to your final grade.

### Due Dates & Submission Instructions

Final projects are typically presented during the last 2–3 days of class. Written reports and slides are due on or before the first presentation day. See the course syllabus or schedule for specific dates and other details for the current semester.

* **Part 1: Project Proposal.** Submitted earlier in the term (see the syllabus or schedule for the exact due date).
* **Part 2: Written Report with Code.** Due on or before the first presentation day.
* **Part 3: Oral Presentation.** Delivered during the last 2–3 class meetings (a signup sheet will be available later in the term).

**Submission.** See the course syllabus or schedule for where and how to submit project materials. The oral presentation just needs to be delivered on your assigned day but does not need to be turned in separately.
...
* **Length:** ~1 page 
* **Due Date:** See the course syllabus or schedule
...
* **Due Date:** On or before the first presentation day (see the course syllabus or schedule)
...
* **Length:** Plan to give your presentation within an ~15-minute slot, structured as a 10-12 minute talk followed by 3-5 minutes for questions and discussion
* **Date:** Typically during the last 2–3 days of class (see the course syllabus or schedule; a signup sheet will be available later in the term)
...
>    + [Stanford DataWorks](https://dataworks.stanford.edu/)
>    + [LINCS Data Portal Datasets](https://lincsportal.ccs.miami.edu/datasets/)
{: .callout}
